...
public class WeaponSway : MonoBehaviour
{
    ...
    private Vector3 currentPos;//현재위치

    [SerializeField]
    private Vector3 limitPos;//무기가최대얼마나흔들릴수있는지

    [SerializeField]
    private Vector3 fineSightLimitPos;//정조준시sway한계

    [SerializeField]
    private Vector3 smoothSway; //부드러운움직임정도
